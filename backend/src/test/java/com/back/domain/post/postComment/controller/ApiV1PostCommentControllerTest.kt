    ...
    fun t2() {
        ...
        for (i in comments.indices) {
            ...
            resultActions
                ...
                .andExpect(jsonPath("$[$i].createDate").value(Matchers.startsWith(postComment.createDate.toString().substring(0, 20))))
                .andExpect(jsonPath("$[$i].modifyDate").value(Matchers.startsWith(postComment.modifyDate.toString().substring(0, 20))))
