...
class ApiV1PostControllerTest @Autowired constructor(
    ...
    fun t12() {
        ...
        resultActions
            ...
            .andExpect(jsonPath("$.msg").value("${id}번 글 수정권한이 없습니다."))
    }
    ...
    fun t13() {
        ...
        resultActions
            ...
            .andExpect(jsonPath("$.msg").value("${id}번 글 삭제권한이 없습니다."))
    }
    ...
    fun t5() {
        ...
        for (i in posts.indices) {
            ...
            resultActions
                ...
                .andExpect(jsonPath("$[$i].createDate").value(Matchers.startsWith(post.createDate.toString().substring(0, 20))))
                .andExpect(jsonPath("$[$i].modifyDate").value(Matchers.startsWith(post.modifyDate.toString().substring(0, 20))))
                .andExpect(jsonPath("$[$i].authorId").value(post.author.id))
                .andExpect(jsonPath("$[$i].authorName").value(post.author.nickname))
